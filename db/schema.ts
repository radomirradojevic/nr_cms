...
export const cmsAddonInstallations = pgTable(
  "cms_addon_installations",
  {
    ...
    installationDeploymentEpoch: bigint("installation_deployment_epoch", { mode: "bigint" }).notNull().default(BigInt(0)),
    entitlementSnapshotHash: text("entitlement_snapshot_hash"),
...
export const cmsAddonOperations = pgTable("cms_addon_operations", {
  ...
  installationId: uuid("installation_id"),
  installationDeploymentEpoch: bigint("installation_deployment_epoch", { mode: "bigint" }),
...
export const cmsAddonDeploymentOutbox = pgTable("cms_addon_deployment_outbox", {
  ...
  installationDeploymentEpoch: bigint("installation_deployment_epoch", { mode: "bigint" }).notNull(),
...
export const cmsAddonServingFences = pgTable("cms_addon_serving_fences", {
  ...
  installationDeploymentEpoch: bigint("installation_deployment_epoch", { mode: "bigint" }).notNull(), generation: integer("generation").notNull(),
