...
async function seed() {
  await db.insert(links).values([
    ...
    { shortCode: 'planetscale', originalUrl: 'https://planetscale.com', userId },
    ...
    { shortCode: 'azure', originalUrl: 'https://azure.microsoft.com', userId },
    { shortCode: 'docker', originalUrl: 'https://docker.com', userId },
    { shortCode: 'k8s', originalUrl: 'https://kubernetes.io', userId },
    { shortCode: 'gh-actions', originalUrl: 'https://github.com/features/actions', userId },
    ...
    { shortCode: 'storybook', originalUrl: 'https://storybook.js.org', userId },
